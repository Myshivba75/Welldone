...
class NorenApi:
    ...
    def token_setter(self):    
        ectoken=open("finvakey.txt",'r').read().rstrip()
        self.__username   = "FA52724"
        self.__accountid  = "FA52724"
        self.__password   = "Asd@#$23"
        self.__susertoken = ectoken
